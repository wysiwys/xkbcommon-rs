...
fn keyseq() {
    ...
    let keymap = test_compile_rules(ctx.clone(),
        Some("evdev"), Some("evdev"),
        Some("us,il,ru,de"),
        Some(",,phonetic,neo"),
...
(Key::KEY_RIGHTSHIFT,   Down,   Keysym::Shift_R),
    ...
    let keymap = test_compile_rules(ctx.clone(), 
        Some("evdev"), Some(""), Some("de"), 
        Some("neo"), Some("")).unwrap();
    ...
    test_key_seq(&keymap,
        ...
        (Key::KEY_V,            Both,   Keysym::Greek_pi),
        (Key::KEY_RIGHTSHIFT,   Up,     Keysym::Caps_Lock),
    ...
    let keymap = test_compile_rules(ctx.clone(), 
        Some("evdev"), Some(""), Some("us,il,ru"), 
        Some(""), Some("grp:alt_shift_toggle_bidir,grp:menu_toggle")).unwrap();
    ...
    let keymap = test_compile_rules(ctx.clone(), 
        Some("evdev"), Some(""), Some("us,il,ru"), 
        Some(""), Some("grp:switch,grp:lswitch,grp:menu_toggle")).unwrap();
    ...
    let keymap = test_compile_rules(ctx.clone(), 
        Some("evdev"), Some(""), Some("us"), 
        Some("euro"), Some("")).unwrap();
    ...
    let keymap = test_compile_file(ctx.clone(),
    "keymaps/unbound-vmod.xkb").unwrap();
    ...
    let keymap = test_compile_rules(ctx.clone(), 
        Some("evdev"), Some("applealu_ansi"), Some("us"), 
        Some(""), Some("terminate:ctrl_alt_bksp")).unwrap();
